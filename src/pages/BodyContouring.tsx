              ...
              <CardContent className="p-12">
                <div className="prose prose-lg max-w-none">
                  <p className="text-lg text-muted-foreground mb-6">
                    Content coming soon. Learn about our body contouring services.
                  </p>
        ...
        <section className="py-16 px-6 lg:px-8 bg-muted/30">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4">Transform Your Body</h2>
              <p className="text-lg text-muted-foreground">
                Contact us to learn more about our body contouring treatments and schedule your consultation.
              </p>
            </div>
            <Card>
