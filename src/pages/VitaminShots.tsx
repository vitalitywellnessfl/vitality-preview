              ...
              <CardContent className="p-12">
                <div className="prose prose-lg max-w-none">
                  <p className="text-lg text-muted-foreground mb-6">
                    Content coming soon. Explore our vitamin injection therapy services.
                  </p>
        ...
        <section className="py-16 px-6 lg:px-8 bg-muted/30">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4">Ready for an Energy Boost?</h2>
              <p className="text-lg text-muted-foreground">
                Get in touch to learn about our vitamin shot options and schedule your appointment.
              </p>
            </div>
            <Card>
